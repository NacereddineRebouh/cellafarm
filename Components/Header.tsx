...
export default function Header({}: Props) {
  return (
    <header className="fixed w-screen top-0 max-w-[2200px] z-50 backdrop-blur-[1px]">
      <div className="h-20 grid grid-cols-[1fr_4fr] text-[17px] px-6 sm:px-20 md:px-32 xl:px-40 bg-[#FAFAFA]/40">
        ...
        <div className="justify-end flex flex-row items-center gap-12 mr-0 font-medium">
          ...
          <Link className="lg:flex hidden" href="/Products">
            <div className="rounded-full px-4 py-3 transition-all duration-300 hover:bg-zinc-200">
              Products
            </div>
          </Link>
          ...
          <Link className="lg:flex hidden" href="#ContactUs">
            <div className="rounded-full px-4 py-3 transition-all duration-300 hover:bg-zinc-200">
              Contact
            </div>
          </Link>
